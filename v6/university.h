...
#define SCHOOLNAME "Ho Chi Minh City University of Technology"
#define SCHOOLCOURSE "Computer Science"
...
//A work is either an Assignment, a Test or an Exam
class Work{
    friend class Student;
    friend class UniversityStudent;
    friend class CollegeStudent;
...
class Semester{
    ...
    public:
    Semester(int __A=0, int __T=0, int __E=0);
    ~Semester();
};
